          ...
          <Col xs="10" lg="4">
            <Form.Group controlId="Form.Input">
              <InputGroup>
                ...
                <Form.Control title="Enter Amount" as="input" placeholder="Enter amount" onChange={this.handleChange} defaultValue={this.props.state.amount} className="text-right"></Form.Control>
              </InputGroup>
            </Form.Group>
          </Col>
        </Row>
